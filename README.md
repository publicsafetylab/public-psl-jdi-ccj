...
This repository makes publicly available the data used for an updated report released in December 2020, which drew upon a sample of approximately 19 million daily individual-level daily jail records collected between January 1, 2020 and October 22, 2020. The updated report is available <a href="https://covid19.counciloncj.org/2020/12/06/impact-report-covid-19-and-jails/">here</a>. The data in this repository are aggregated to the roster/day level.
